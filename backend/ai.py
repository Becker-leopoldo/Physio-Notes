...
{{
  ...
  "pago": <boolean true se o pagamento já foi realizado, false se ainda é uma promessa ou valor a receber/pendente. Padrão: true>,
...
{transcricao}"""
    ...
    try:
        ...
        result = {"total_sessoes": None, "pago": True, "valor_pago": None, "data_pagamento": None, "descricao": None}

    for chave in ("total_sessoes", "pago", "valor_pago", "data_pagamento", "descricao"):
        result.setdefault(chave, None)

    if result["pago"] is None:
        result["pago"] = True
